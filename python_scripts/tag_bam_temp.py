...
class readArgs(object):
    ...
    def parse(self):
        ...
        # Arguments
        parser.add_argument("input_mapped_bam", help=".fastq file with trimmed reads which is to be tagged with barcode id:s.")
        parser.add_argument("input_clstr", help=".clstr file from cdhit clustering.")
        parser.add_argument("output_tagged_bam", help=".fastq file tagged with barcode consensus sequence")
